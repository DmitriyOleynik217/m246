<?php
namespace SR\Codemirror\Block\Adminhtml\System\Config\Form\Field\Editor;

/**
 * Interceptor class for @see \SR\Codemirror\Block\Adminhtml\System\Config\Form\Field\Editor
 */
class Interceptor extends \SR\Codemirror\Block\Adminhtml\System\Config\Form\Field\Editor implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'initJsLayout');
        return $pluginInfo ? $this->___callPlugins('initJsLayout', func_get_args(), $pluginInfo) : parent::initJsLayout();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isLineWrapping');
        return $pluginInfo ? $this->___callPlugins('isLineWrapping', func_get_args(), $pluginInfo) : parent::isLineWrapping();
    }
