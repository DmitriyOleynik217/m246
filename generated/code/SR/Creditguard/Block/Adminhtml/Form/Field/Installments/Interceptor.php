<?php
namespace SR\Creditguard\Block\Adminhtml\Form\Field\Installments;

/**
 * Interceptor class for @see \SR\Creditguard\Block\Adminhtml\Form\Field\Installments
 */
class Interceptor extends \SR\Creditguard\Block\Adminhtml\Form\Field\Installments implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function addColumn($name, $params)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addColumn', func_get_args(), $pluginInfo) : parent::addColumn($name, $params);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getArrayRows');
        return $pluginInfo ? $this->___callPlugins('getArrayRows', func_get_args(), $pluginInfo) : parent::getArrayRows();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'renderCellTemplate');
        return $pluginInfo ? $this->___callPlugins('renderCellTemplate', func_get_args(), $pluginInfo) : parent::renderCellTemplate($columnName);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isAddAfter');
        return $pluginInfo ? $this->___callPlugins('isAddAfter', func_get_args(), $pluginInfo) : parent::isAddAfter();
    }
    ...
    public function getAddButtonLabel()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getAddButtonLabel', func_get_args(), $pluginInfo) : parent::getAddButtonLabel();
    }
