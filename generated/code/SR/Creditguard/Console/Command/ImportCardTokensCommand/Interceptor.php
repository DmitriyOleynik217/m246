<?php
namespace SR\Creditguard\Console\Command\ImportCardTokensCommand;

/**
 * Interceptor class for @see \SR\Creditguard\Console\Command\ImportCardTokensCommand
 */
class Interceptor extends \SR\Creditguard\Console\Command\ImportCardTokensCommand implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\App\State $state, \SR\Creditguard\Model\State $creditguardModuleState, \SR\Creditguard\Model\Import\Vault\TokenSourceDataManager $sourceDataManager, \SR\Creditguard\Model\Import\Vault\TokenFieldMapper $fieldMapper, \SR\Creditguard\Model\Import\Vault\TokenImportNew $importModel, $name = null)
    {
        $this->___init();
