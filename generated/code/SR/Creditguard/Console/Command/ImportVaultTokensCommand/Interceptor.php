<?php
namespace SR\Creditguard\Console\Command\ImportVaultTokensCommand;

/**
 * Interceptor class for @see \SR\Creditguard\Console\Command\ImportVaultTokensCommand
 */
class Interceptor extends \SR\Creditguard\Console\Command\ImportVaultTokensCommand implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\App\State $state, \SR\Creditguard\Model\State $creditguardModuleState, \SR\Creditguard\Model\Import\Vault\TokenSourceDataManager $sourceDataManager, \SR\Creditguard\Model\Import\Vault\TokenFieldMapper $fieldMapper, \SR\Creditguard\Model\Import\Vault\TokenImport $importModel, $name = null)
    {
        $this->___init();
        parent::__construct($state, $creditguardModuleState, $sourceDataManager, $fieldMapper, $importModel, $name);
    }
