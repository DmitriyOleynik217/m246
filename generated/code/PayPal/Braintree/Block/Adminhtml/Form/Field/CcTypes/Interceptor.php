...
class Interceptor extends \PayPal\Braintree\Block\Adminhtml\Form\Field\CcTypes implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setInputName');
        return $pluginInfo ? $this->___callPlugins('setInputName', func_get_args(), $pluginInfo) : parent::setInputName($value);
    }
    ...
    public function addOption($value, $label, $params = [])
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addOption', func_get_args(), $pluginInfo) : parent::addOption($value, $label, $params);
    }
    ...
    public function setId($elementId)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('setId', func_get_args(), $pluginInfo) : parent::setId($elementId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setClass');
        return $pluginInfo ? $this->___callPlugins('setClass', func_get_args(), $pluginInfo) : parent::setClass($class);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'calcOptionHash');
        return $pluginInfo ? $this->___callPlugins('calcOptionHash', func_get_args(), $pluginInfo) : parent::calcOptionHash($optionValue);
    }
