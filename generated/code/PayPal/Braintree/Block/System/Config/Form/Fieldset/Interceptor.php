...
class Interceptor extends \PayPal\Braintree\Block\System\Config\Form\Fieldset implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Backend\Block\Context $context, \Magento\Backend\Model\Auth\Session $authSession, \Magento\Framework\View\Helper\Js $jsHelper, \Magento\Config\Model\Config $backendConfig, \PayPal\Braintree\Gateway\Config\PayPalCredit\Config $config, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $authSession, $jsHelper, $backendConfig, $config, $data);
    }
