...
class Interceptor extends \Magento\PageBuilder\Block\GoogleMapsApi implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLibraryUrl');
        return $pluginInfo ? $this->___callPlugins('getLibraryUrl', func_get_args(), $pluginInfo) : parent::getLibraryUrl();
    }
    ...
    public function getStyle() : ?string
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getStyle', func_get_args(), $pluginInfo) : parent::getStyle();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getInvalidApiKeyMessage');
        return $pluginInfo ? $this->___callPlugins('getInvalidApiKeyMessage', func_get_args(), $pluginInfo) : parent::getInvalidApiKeyMessage();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'shouldIncludeGoogleMapsLibrary');
        return $pluginInfo ? $this->___callPlugins('shouldIncludeGoogleMapsLibrary', func_get_args(), $pluginInfo) : parent::shouldIncludeGoogleMapsLibrary();
    }
