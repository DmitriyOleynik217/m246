...
class Interceptor extends \Magento\Paypal\Block\Adminhtml\System\Config\PayLaterLink implements \Magento\Framework\Interception\InterceptorInterface
{
     ...
     * {@inheritdoc}
     */
    public function _getElementHtml(\Magento\Framework\Data\Form\Element\AbstractElement $element) : string
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_getElementHtml');
        return $pluginInfo ? $this->___callPlugins('_getElementHtml', func_get_args(), $pluginInfo) : parent::_getElementHtml($element);
    }
